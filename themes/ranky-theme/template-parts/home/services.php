...
$title_light = get_field('services_section_title_light');
$title_bold = get_field('services_section_title_bold');
  ...
  <div class="container">
    ...
    <?php if ($title_light || $title_bold): ?>
      <h2 class="services__title">
        <?php 
          if ($title_light) {
            echo '<span class="services__title-light">' . esc_html($title_light) . '</span>';
            if ($title_bold) {
              echo ' ';
            }
          }
          if ($title_bold) {
            echo '<span class="services__title-bold">' . esc_html($title_bold) . '</span>';
          }
        ?>
      </h2>
    <?php endif; ?>
